...
import { PencilIcon, XMarkIcon, CheckIcon, StarIcon } from './icons.tsx';
      ...
      >
        ...
        {onToggleFavorite && (
          <button
            ...
            className="absolute top-3 right-3 z-20 p-2 rounded-full bg-black/40 hover:bg-black/60 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
